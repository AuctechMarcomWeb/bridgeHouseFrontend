  ...
  useEffect(() => {
    getRequest("category")
      .then((res) => {
        ...
        console.log("Category response:", cats);
        setCategories(cats);
      })
  ...
  return (
    ...
    "
      ...
      <button
        ...
        className="fixed bottom-6 right-6 bg-[#004f8a] hover:bg-[#0066b2] text-white p-3 rounded-full shadow-lg transition-colors z-50"
