...
export default function RealEstateProfile() {
  ...
  const handleSave = (updatedUser) => {
    setUser(updatedUser); // update profile
  };
          ...
          <div className="bg-[#004d88] p-8">
            <div className="flex flex-col lg:flex-row items-start lg:items-center gap-6">
              ...
              <div className="flex-1 text-white">
                ...
                <p className="text-blue-100 text-sm mb-4">{user.title}</p>
              ...
              <button   onClick={() => setShowEdit(true)} className="px-6 py-3 bg-white text-blue-600 font-semibold rounded-xl hover:bg-blue-50 transition-all duration-300 shadow-lg">
                Edit Profile
              </button>
            </div>
          </div>
